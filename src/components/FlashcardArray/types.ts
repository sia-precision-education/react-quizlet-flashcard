export default interface FlashcardArrayProps {
  ...
  cards: Array<{
     ...
     */
    frontCardStyle?: React.CSSProperties | string;
    /**
     * Styles for the content of the front facing card.
     */
    frontContentStyle?: React.CSSProperties | string;
    /**
     * Styles for the back of the card.
     */
    backCardStyle?: React.CSSProperties | string;
    /**
     *
     * Styles for the content of the back facing card.
     */
    backContentStyle?: React.CSSProperties | string;
    /**
   ...
   */
  FlashcardArrayStyle?: React.CSSProperties | string;
  /**
